package com.tonilopezmr.xproject.bluetooth;
...
import com.tonilopezmr.xproject.R;
import com.tonilopezmr.xproject.commands.Command;
import com.tonilopezmr.xproject.commands.PrintPicture;
import com.tonilopezmr.xproject.commands.PrinterCommand;
...
public class Main_Activity extends Activity implements OnClickListener{
    ...
    final String[] itemsen = {
            ...
            "Normal size",
            "Double high power wide",
            "Twice as high power wide",
            "Three times the high-powered wide",
            "Off emphasized mode",
            "Choose bold mode",
            "Cancel inverted Print",
            "Invert selection Print",
            "Cancel black and white reverse display",
            "Choose black and white reverse display",
            "Cancel rotated clockwise 90 °",
            "Select the clockwise rotation of 90 °",
            "Feed paper Cut",
            "Beep",
            "Standard CashBox",
            "Open CashBox",
